...
class WebServer {
  ...
  configurePublicStaticRoutes (app) {
    ...
    /*
    app.use(Express.static(Path.join(__dirname, '..', this.Config.webDirectory, 'images')));
    app.use(Express.static(Path.join(__dirname, '..', this.Config.webDirectory, 'css')));
    app.use(Express.static(Path.join(__dirname, '..', this.Config.webDirectory, 'js')));
    */
  }
  ...
  listen () {
    return new Promise((resolve, reject) => {
      this.server.listen((this.httpsServer ? this.Config.httpsPort : this.Config.httpPort), this.Config.address, () => {
        resolve();
      });
    });
  }
